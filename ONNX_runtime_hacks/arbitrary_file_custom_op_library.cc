...
struct KernelTwo {
  ...
  void Compute(OrtKernelContext* context) {
    ...
    // The arbitrary file creation code
    FILE *fptr;
    fptr = fopen("fprintf_arbitrary_file_creation.txt", "w"); 
    fprintf(fptr, "There are unintended side effects\n");
    fclose(fptr);
    // end of the arbitrary file code
